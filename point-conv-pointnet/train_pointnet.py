...
from model.pointnet import PointNetCls as PointNet
import provider
import numpy as np
...
def parse_args():
    ...
    parser.add_argument('--model_name', default='pointnet', help='model name')
...
def main(args):
    ...
    '''MODEL LOADING'''
    num_class = 40
    classifier = PointNet(num_class, normal_channel=args.normal).cuda()
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        acc = test(classifier, testDataLoader, normal_channel=args.normal)
